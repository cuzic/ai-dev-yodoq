...
- **適したダイアグラム:**
  ...
  - 大規模な構成図
- **情報量:** 30-50要素
- **注意:** 横長を活かしたレイアウト、左右の流れを意識

#### layout-horizontal-right（右側ダイアグラム）
- **使用頻度:** ★★★★★ (23回使用)
- **縦横比:** 8:9（やや縦長）
- **推奨viewBox:** 800×900
- **表示領域:** スライドの右半分（約450px × 500px）
- **適したダイアグラム:**
  - プロセス図（縦方向のステップ）
  - 階層構造（トップダウン）
  - 状態遷移図
  - 概念図（上下の関係性）
- **情報量:** 15-25要素
- **注意:** 縦長を活かし、上から下への流れを意識

#### layout-horizontal-left（左側ダイアグラム）
- **使用頻度:** ★★★★★ (19回使用)
- **縦横比:** 8:9（やや縦長）
- **推奨viewBox:** 800×900
- **表示領域:** スライドの左半分（約450px × 500px）
- **適したダイアグラム:** layout-horizontal-rightと同様
- **情報量:** 15-25要素
- **注意:** 右側のテキストとの対応を考慮

#### layout-comparison（比較用）
- **使用頻度:** ★★ (5回使用)
- **縦横比:** 1:1（正方形）
- **推奨viewBox:** 700×700
- **表示領域:** 中央配置（約350px × 350px）
- **適したダイアグラム:**
  - Before/After比較
  - 2つの概念の対比
  - バランス図
...
# レイアウトマッピング
LAYOUT_SPECS = {
    'layout-diagram-only': {'viewBox': (1600, 900), 'aspect': '16:9'},
    'layout-horizontal-right': {'viewBox': (800, 900), 'aspect': '8:9'},
    'layout-horizontal-left': {'viewBox': (800, 900), 'aspect': '8:9'},
    'layout-comparison': {'viewBox': (700, 700), 'aspect': '1:1'},
    'layout-callout': {'viewBox': (600, 400), 'aspect': '3:2'},
    'card-grid': {'viewBox': (500, 300), 'aspect': '5:3'},
    'two-column': {'viewBox': (600, 600), 'aspect': '1:1'},
}
...
**具体例:**
- **layout-diagram-only (1600×900)**: タイトル58px, 見出し45px, 本文32px, 注釈22px
- **layout-horizontal-right (800×900)**: タイトル46px, 見出し36px, 本文26px, 注釈18px
- **layout-callout (600×400)**: タイトル35px, 見出し27px, 本文19px, 注釈13px
